...
export default {
  async fetch(request: Request): Promise<Response> {
    ...
    const title = `Highly Accessible Tools For ${name}`;
    ...
    const htmlString = html`<!DOCTYPE html>
      <html lang="en">
        ...
        <body>
          ...
          <div class="info">
            Replace 'github.com' with 'forgithub.com' to find highly accessible
            github tools
          </div>

          <div class="current-path">Current path: ${pathname}</div>
          ...
          <script>
            ...
            let starredEndpoints = new Set(
              JSON.parse(localStorage.getItem("starredEndpoints") || "[]"),
            );
            ...
            function toggleStar(urlId) {
              ...
              localStorage.setItem(
                "starredEndpoints",
                JSON.stringify([...starredEndpoints]),
              );
              sortCards();
            }
            ...
            function sortCards() {
              ...
              const cards = Array.from(
                container.getElementsByClassName("link-card"),
              );
            ...
            searchInput.addEventListener("input", (e) => {
              ...
              Array.from(cards).forEach((card) => {
                ...
                const url = card
                  ...
                  .textContent.toLowerCase();
                const isVisible =
                  description.includes(searchTerm) || url.includes(searchTerm);
